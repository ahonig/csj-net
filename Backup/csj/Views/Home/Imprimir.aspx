...
<html lang="es">
  ...
  <script>
      ...
      function generarPdf(pQRCode) {
          ...
          var mt = parseInt(2);
          var ml = parseInt(2);
          doc.addFont("/Content/font/Montserrat-Bold.ttf", "Montserrat", "normal");

          var background = new Image();
          background.src = "/Content/pattern.png";
          doc.addImage(background, 'PNG', 0, 0);

          var csjLogo = new Image();
          csjLogo.src = "/Content/corte_suprema.png";
          ...
          portrait.src = "/Content/"+codigoCarnet+".png";
          doc.addImage(portrait, 'PNG', ml + 53, mt + 2.7, 30, 40 );
          

          doc.addPage();
          //Pagina 2
          doc.text("EL SECRETARIO GENERAL DE LA CORTE SUPREMA DE JUSTICIA CERTIFICA QUE: <%= (@pers != null ? @pers.nombres : "") %> <%= (@pers != null ? @pers.apellidos : "")%> SE HALLA INSCRIPTO EN LA MATRÍCULA DE ABOGADO CON EL Nº <%= (@prof != null ? @prof.matricula_nro : "")%>. ASUNCIÓN, 20/07/2022. ESTA CREDENCIAL ES DE LA CORTE SUPREMA DE JUSTICIA.", ml + 2.2, mt + 2.2, { maxWidth: 80, align: "justify" });
          ...
          doc.text(ml + 2.2, mt + 47, 'GONZALO E. SOSA NICOLI');
          doc.setFontSize(5);
          doc.text(ml + 2.2, mt + 49, 'SECRETARIO GENERAL');
