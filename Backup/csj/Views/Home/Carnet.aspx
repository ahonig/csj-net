		            ...
		            <form id="generarCarnet" target="_self" onSubmit="return guardarCarnet(event);">
			            <div class="card ">
							        ...
							        <div class="col-md-4 text-center">
                                        <div id="camera-sector">
                                            <div class="camera-portrait">
											    ...
											    <img id="avatar" src="/Content/img/bussines-avatar-3x4.jpg" alt="..." style="width: 80%" />
								            </div>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a class="btn btn-fill btn-danger pull-right" onClick="javascript:cancelarCarnet();">Cancelar<div class="ripple-container"></div></a>
                            </div>
                        </div>
		            </form>
                </div>
...
<script>
    ...
    function buscarCarnet(e){
        ...
        if ( $("#formularioBuscar").valid() ){
            ...
            window.open("/Home/Carnet/"+matricula+"?tipo="+tipoProfesional+"&cedula="+cedula+"&liquidacion="+liquidacion,"_self");
        }
        return false;
    }
    ...
    function guardarCarnet(e){
        ...
        $.post('/Home/GuardarCarnet',data).done(function (resp){
    ...
    function generarPdf(pCarnetID){
        ...
        $(".preview-pane").attr("src","/Home/Imprimir/"+pCarnetID);
        $("#confirmar").hide();
        $("#camera-sector").hide();
        $(".preview-pane").show();
