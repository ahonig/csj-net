...
<html lang="es">
  <head>
    ...
    <link rel="stylesheet" href="/Content/corte.css?v=1.0">
            ...
            <div class="card-body m-0">
              <div class="row align-items-center rowinsidecard">
                <div class="col colinfo">
                  <div class="row">
                    <div class="col-12">
                      <img src="/Content/corte_suprema.svg" class="img-fluid logocorte" />
                      <div class="row visible_vertical justify-content-center">
                        <div class="col-6 mb-3">
                          <img src="/Content/<%= (@carn != null ? @carn.carnet_qr : "")%>.png" class="img-fluid" />
                        </div>
                        <!-- col -->
                      </div>
                      <!-- row -->
